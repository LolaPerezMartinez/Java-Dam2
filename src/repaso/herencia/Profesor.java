...
public class Profesor extends Profesion{
	...
	public void trabajar() {
		System.out.println("El profesor ["+ getNombre() +"] está enseñando [" +
					 getEspecialidad() + "] a sus estudiantes.");
	}
	
	public void calificarExamenes(int cantidadEstudiantes) {
		System.out.println("El profesor ["+ getNombre()+ "] ha calificado ["
				+ cantidadEstudiantes + "] exámenes.");
	}
